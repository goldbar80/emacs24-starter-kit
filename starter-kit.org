...
These packages are added by goldbar (borrowed from Kieran Healy's
emacs starter kit fork)
- [[file:starter-kit-elpa.org][elpa]]
- [[file:starter-kit-latex.org][latex]]
...
- ELPA archive repositories and two packages to install by
  default. (by goldbar)
  #+begin_src emacs-lisp
    (starter-kit-load "elpa")
  #+end_src
...
- org mode
  #+name: starter kit org
  #+begin_src emacs-lisp
    (starter-kit-load "org")    
  #+end_src

- latex mode
  #+name: starter kit latex
  #+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (flet ((sk-load (base)
    ...
    (let ((elisp-dir (expand-file-name "src" starter-kit-dir))
          (submodule-dir (expand-file-name "submodules" starter-kit-dir)) ;; by goldbar
          (user-dir (expand-file-name user-login-name starter-kit-dir)))
      ;; add the src directory to the load path
      (add-to-list 'load-path elisp-dir)
      ;; add the submodule directory to the load path ;; by goldbar
      (add-to-list 'load-path submodule-dir)
      ;; load specific files - elisp-dir
      (when (file-exists-p elisp-dir)
        (let ((default-directory elisp-dir))
          (normal-top-level-add-subdirs-to-load-path)))
      ;; load specific files - submoule-dir 
      (when (file-exists-p submodule-dir)
